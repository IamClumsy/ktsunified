...
const ShopsTab        = lazy(() => import("@/app/components/shops/shops-tab").then((m) => ({ default: m.ShopsTab })));

type Tab = "sr-artists" | "new-artists" | "resource-calc" | "ceo-event" | "svs-store" | "team-builder" | "shops";
...
const TABS: {
  ...
  { id: "new-artists",    label: "SSR Artists",        shortLabel: "SSR",    activeClass: "bg-pink-600 text-white border-pink-500" },
  { id: "sr-artists",     label: "SR Artists",         shortLabel: "SR",     activeClass: "bg-pink-600 text-white border-pink-500" },
  { id: "resource-calc",  label: "Resource Calc",      shortLabel: "Calc",   activeClass: "bg-pink-600 text-white border-pink-500" },
  { id: "ceo-event",      label: "Event Calculators",  shortLabel: "Events", activeClass: "bg-pink-600 text-white border-pink-500" },
  { id: "svs-store",      label: "SVS Store",          shortLabel: "SVS",    activeClass: "bg-pink-600 text-white border-pink-500" },
  { id: "team-builder",   label: "Team Builder",       shortLabel: "Team",   activeClass: "bg-pink-600 text-white border-pink-500" },
  { id: "shops",          label: "Shops",              shortLabel: "Shops",  activeClass: "bg-pink-600 text-white border-pink-500" },
];
    ...
    <div className="min-h-screen text-white">
      ...
      <header className="sticky top-0 z-50 bg-slate-950/85 backdrop-blur-xl border-b border-slate-800/60 shadow-lg">
        ...
        <div className="md:hidden flex items-center gap-3 h-12 px-4">
          ...
          <span className="text-base font-extrabold tracking-widest text-slate-100 uppercase">KTS 1118</span>
          <span className="ml-auto text-xs text-pink-400 font-medium truncate">{activeTabLabel}</span>
        </div>
        ...
        <div className="hidden md:block mx-auto max-w-7xl px-4 pt-3 pb-2">
          <div className="flex items-center justify-center gap-3 mb-2">
            ...
            <span className="text-2xl font-extrabold tracking-widest text-slate-100 uppercase">KTS 1118</span>
          </div>
        ...
        {TABS.map((tab) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <span className="absolute bottom-[calc(env(safe-area-inset-bottom)+0px)] w-8 h-0.5 rounded-full bg-pink-500" aria-hidden="true" />
              )}
            </button>
          );
        })}
