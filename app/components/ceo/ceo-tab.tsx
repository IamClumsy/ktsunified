...
const BTN: Record<Color, { inactive: string; active: string }> = {
  ...
  emerald: {
    inactive:
      "border-emerald-700/50 text-emerald-400 hover:border-emerald-400 hover:text-emerald-200",
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
            <div className="flex gap-2">
              ...
              <span className="text-slate-400">
                Quantity used × points per task. Each category shows a subtotal; all categories sum
                to your total event points.
              </span>
            </div>
            <div className="flex gap-2">
              <span className="text-cyan-400 font-bold shrink-0">EXP Cards</span>
              <span className="text-slate-400">
                EXP Card x24 tasks divide by 24 — enter the raw number of cards, the calculator
                converts to uses automatically.
              </span>
            </div>
            <div className="flex gap-2">
              <span className="text-emerald-400 font-bold shrink-0">Events</span>
              <span className="text-slate-400">
                Each tab is a separate event type. Use the Reset button to clear all quantities for
                the current event.
              </span>
            </div>
            <div className="flex gap-2">
              ...
              <span className="text-slate-400">
                The grand total at the bottom is your projected event point score based on the
                quantities entered.
              </span>
            </div>
          </div>
